...
export const signupUser = async (req: Request, res: Response) => {
  try {
    const { email, password, name, company, phone, role, country, terms } =
      req.body;
...
// export const loginAuthAdmin = async (req: Request, res: Response) => {
//   try {
...
//     const user = await Auth.findOne({ $or:[{email: key}, {name: key}] });
...
//     await Auth.updateOne({ email: user.email }, { otp });
...
//           <p>Hello ${user.name},</p>
//           <p>Welcome on Aboard, your OTP is ${otp}</p>
//           <p>Thank you,</p>
//         </div>
//       `,
//     });
